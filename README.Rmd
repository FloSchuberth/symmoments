...
Symbolically computes and numerically evaluates multivariate normal moments \eqn{E[X_1^{k_1} \cdots X_n^{k_n}]}, where \eqn{(X_1,\ldots,X_n) \sim N(\mu, \Sigma)}, in terms of mu and S elements.
